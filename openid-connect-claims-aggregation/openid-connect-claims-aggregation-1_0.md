...
**OP** â€“ OpenID Provider

**CP** â€“ Claims Provider
...
1. The Claims to be granted MUST be specified with `scope` parameter. 
...
----> 1. the RP MUST verify that the  aud  (audience) Claim is not present; 
