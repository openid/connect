...
The user visits the administration office of her university, or logs into her university account, in order to authenticate herself (either face to face or remotely) prior to picking up her digital diploma. The office staff or the university's web site then starts the issuance process. The user is asked to scan a QR Code to retrieve the digital diploma. She scans the QR code with her smartphone, which automatically starts her wallet, where she is notified of the offer to create a digital diploma (the verifiable credential). The wallet displays the contents of the offered credential to the user. The user may be allowed to deselect certain properties that she does not want to be in her credential e.g. her gender. When the user is happy with the selected set of properties, she consents, which causes the wallet to subsequently obtain and store the verifiable credential in the wallet.
